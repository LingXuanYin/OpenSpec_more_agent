...
`;
    ...
    it('should update all 11 skill files when tool is configured', async () => {
  ...
  describe('command updates', () => {
    ...
    it('should update all 11 opsx commands when tool is configured', async () => {
  ...
  describe('skill content validation', () => {
    ...
    it('should refresh workflow skills with role orchestration protocol', async () => {
      ...
      for (const skillName of workflowSkills) {
        ...
        await fs.writeFile(path.join(skillsDir, skillName, 'SKILL.md'), 'old');
      }
...
`;
  ...
  describe('legacy tool upgrade', () => {
    ...
    it('should create all 11 skills when upgrading legacy tools', async () => {
      ...
      // Verify all 11 skill directories were created
      const skillNames = [
        'openspec-explore',
        'openspec-deepresearch',
        'openspec-new-change',
